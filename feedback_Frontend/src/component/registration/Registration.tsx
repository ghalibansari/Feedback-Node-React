        ...
        return (
            <div style={customStyle.mainDiv}>
                <Paper style={customStyle.div} variant='elevation'>
                    ...
                    />
                    <br/><br/>
                    <FormLabel style={{width: '70%', marginLeft: 'auto', marginRight: 'auto', textAlign: 'left'}} component="legend" color="secondary">Date of Birth *</FormLabel>
                    <TextField
                        required
                        id=""
                        type="Date"
                        ...
                        //@ts-ignore
                        error={this.state.errors.dobErr}
                        style={customStyle.input}
                    ...
                    <div style={{width: '70%', marginLeft: 'auto', marginRight: 'auto', textAlign: 'left'}}>
                        ...
                        <RadioGroup row style={{marginLeft: 'auto', marginRight: 'auto', alignItems: 'left'}} aria-label="gender" name="gender1" value={this.state.gender} onChange={event => this.inputChange(event, 'gender')}>
